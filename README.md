...
```
docker run --detach --name=willow-application-server --env TZ="Europe/Sofia" --pull=always --network=host --restart=unless-stopped --volume=was-storage:/app/storage ghcr.io/heywillow/willow-application-server
```
